...
import { updateUserIdToNewSystem } from '../../lib/surveyManager';
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        // تحديث المعرف للمستخدمين القدامى إذا لزم الأمر
        try {
          await updateUserIdToNewSystem(formData.preferredName);
        } catch (error) {
          console.error('Error updating user ID:', error);
          // لا نوقف تسجيل الدخول بسبب هذا الخطأ
        }
